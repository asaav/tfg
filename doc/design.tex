...
\begin{figure}
    ...
    \caption{Diagrama donde puede verse el funcionamiento de Mean Shift iteración a iteración}
...
Estos datos, que ya son buenos de por sí, serían aún mejores si contáramos con un conjunto de datos de verdad de fondo que nos sirviera para saber si en los frames que no se encuentra marcado $ball_{id}$ como balón, es debido a que realmente no hay ningún balón o no se ha encontrado. Esto es fácilmente visible en un vídeo pero relativamente complicado de plasmar en papel.
