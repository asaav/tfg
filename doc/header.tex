...
\lstset{language=C,
backgroundcolor=\color[gray]{0.95},% color del fondo
frame=single,		% dibuja un borde
columns=flexible,	% el tamaño de letra se ajusta al ancho
extendedchars=false,
aboveskip=1eM,
basicstyle=\ttfamily,
keywordstyle=\color{black}\ttfamily, %Color de las palabras clave - blue
stringstyle=\color{black}\ttfamily, % Red
commentstyle=\color{black}\ttfamily, % Brown
